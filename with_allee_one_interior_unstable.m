...
%  
 t=zeros(1,M+1);
% 
% -ve direction N=1, M=31000
    x(1,1)=0.1+0.00001;
    y(1,1)=(0.715033916527159/0.699089764061691)*0.00001;
%  +ve direction N=7, M=31000
%     x(1,1)=0.565+0.004;
%     y(1,1)=0.4728920520+0.005;
% 
%     x(2,1)=0.4;
%     y(2,1)=0.001;
%     x(3,1)=0.565+0.004;
%     y(3,1)=0.4728920520+0.001;
%     x(4,1)=0.55;
%     y(4,1)=0.2;
%     x(5,1)=0.1;
%     y(5,1)=0.2;
...
% 
% 
%    plot(0.9785884248, 0.03803289342,'marker','.','markersize',30,'color','red','LineWidth',2);
%    hold on;
% %   
    plot(0.565, 0.4728920520,'marker','o','markersize',10,'color','black','LineWidth',2);
    hold on;
